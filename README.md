...
## 현재 진행 상태
- v1.0.1 Appstore 릴리즈 되었습니다.
- 안드로이드 홈 위젯 적용은 되었으나 일부 테마 기능을 수정 중입니다.
- 테스트하며 일부 버그를 제거하고 있습니다.

## 향후 계획
| 계획 | 설명 |
| --- | --- |
| 앱 스토어 출시 | Play Store에 추가로 출시할 계획입니다. 사용자들이 편리하게 앱을 다운로드하여 이용할 수 있게 할 예정입니다. |
...
| 사용자 인터페이스 개선 | 사용자들의 피드백과 요구에 근거하여 사용자 인터페이스를 개선할 계획입니다. 더 직관적이고 사용하기 편리한 디자인을 구현하고, 사용자들의 요구를 반영하여 UX를 최적화할 예정입니다. |
